...
#define H8_3069F_SCI_SSR_TDRE (1<<7) // send completed
...
int serial_init(int index) {
	...
	sci->smr = 0;
	sci->brr = 64;
	sci->scr = H8_3069F_SCI_SCR_RE | H8_3069F_SCI_SCR_TE; // enable send receive
	sci->ssr = 0;
	return 0;
}
...
int serial_send_byte(int index, unsigned char c) {
	...
	sci->tdr = c;
	sci->ssr &= ~H8_3069F_SCI_SSR_TDRE; // begin send/receive
